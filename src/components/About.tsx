...
const About = () => {
  ...
  return (
    <section id="about" className="py-12 md:py-24 section-container">
      <div className="md:grid md:grid-cols-3 md:gap-16">
        <div className="md:col-span-2">
          <h3 className="numbered-heading mb-6">
            <span className="mr-2">01.</span> About Me
          </h3>
          
          <div className="relative">
            {/* Mobile/small screen image floated right */}
            <div className="float-right ml-6 mb-6 md:hidden max-w-[140px] border-2 border-highlight rounded-lg overflow-hidden">
              <Image 
                src="/profile.JPG" 
                alt="Profile picture"
                width={140}
        ...
        {/* Desktop profile image - only visible on medium screens and up */}
